...
namespace App\Http\Controllers\LoudCrowd;
...
{ public function minify_css($input) {
  ...
  public function Less(){
        ...
        $css = app('App\Http\Controllers\LoudCrowd\ResourceController')->minify_css($parser->getCss());
        ...
        $compiled = app('App\Http\Controllers\LoudCrowd\ResourceController')->minify_css($compiled);
